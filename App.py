...
if uploaded_file is not None:     
    ...
    g = nx.from_pandas_edgelist(data, source = "SOURCE", target = "DESTINATION", edge_attr=['DISTANCE_KM','DURATION_MIN', 'DURATION_HRS', 'SPEED']) #Use the Graph API to create an empty network graph object
    ...
    st.write("Modularity: ", nx_comm.modularity(g, com_1))
    st.write("Partition Quality: ", nx_comm.partition_quality(g, com_1))
